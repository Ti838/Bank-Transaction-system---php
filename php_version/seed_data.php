...
try {
    ...
    $pdo->prepare("INSERT INTO accounts (account_number, user_id, account_type, balance, status) VALUES ('2020000001', ?, 'Savings', 999999999999999.00, 'Active')")->execute([$admin_id]);
    echo "[SUCCESS] Admin seeded - Balance: 999 Trillion BDT\n";
    ...
    $pdo->prepare("INSERT INTO accounts (account_number, user_id, account_type, balance, status) VALUES ('2020000002', ?, 'Savings', 500000000000.00, 'Active')")->execute([$staff_id]);
    echo "[SUCCESS] Staff seeded - Balance: 500 Billion BDT\n";
    ...
    $pdo->prepare("INSERT INTO accounts (account_number, user_id, account_type, balance, status) VALUES ('2020123456', ?, 'Savings', 100000000.00, 'Active')")->execute([$user_id]);
    echo "[SUCCESS] Customer seeded - Balance: 100 Million BDT\n";
