...
try {
    ...
    echo "[SUCCESS] Admin seeded - Balance: 100 Crore BDT (1 Billion)\n";
    ...
    $pdo->prepare("INSERT INTO accounts (account_number, user_id, account_type, balance, status) VALUES ('2020000002', ?, 'Savings', 100000000.00, 'Active')")->execute([$staff_id]);
    echo "[SUCCESS] Staff seeded - Balance: 10 Crore BDT (100 Million)\n";
    ...
    $pdo->prepare("INSERT INTO accounts (account_number, user_id, account_type, balance, status) VALUES ('2020123456', ?, 'Savings', 1000000.00, 'Active')")->execute([$user_id]);
    echo "[SUCCESS] Customer seeded - Balance: 10 Lakh BDT (1 Million)\n";
