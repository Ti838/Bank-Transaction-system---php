...
try {
    ...
    echo "[SUCCESS] Admin seeded - Balance: 1,000,000,000 BDT (1 Billion)\n";
    ...
    $pdo->prepare("INSERT INTO accounts (account_number, user_id, account_type, balance, status) VALUES ('2020000002', ?, 'Savings', 500000000.00, 'Active')")->execute([$staff_id]);
    echo "[SUCCESS] Staff seeded - Balance: 500,000,000 BDT (500 Million)\n";
    ...
    echo "[SUCCESS] Customer seeded - Balance: 100,000,000 BDT (100 Million)\n";
